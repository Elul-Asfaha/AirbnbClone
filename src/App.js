...
function App() {
  ...
  const [filterPropertyAmount, setfilterPropertyAmount] = useState(data.length)//used to tell how many properties are left after the filters are applied in the filter component
  ...
  return (
    <provideData.Provider value={{
      handleToggleFilter, setShowProperty, propertyType, setPropertyType, showProperty, setCurrentFilter,
      currentFilter,
      handleToggleFavorite,
      setFavorite,
      favorite,
