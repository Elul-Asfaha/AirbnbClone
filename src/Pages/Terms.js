...
const Terms=()=>{
    ...
    return(
        <div className="md:w-[80%] lg:w-[60%] mx-auto" id="Help-top">
            ...
            {
            showButton &&
            <button onClick={scrollToTop} className="flex items-center justify-center py-2 dark:bg-white dark:text-black bg-black text-white rounded-lg max-w-[150px] fixed bottom-20 z-50 right-8 px-5 py-3 text-md hover:underline" > 
